...
class StatsApi(object):
    ...
    def rest_v20_dd_systems_systemid_stats_get(self, system_id, **kwargs):  # noqa: E501
        """Get stats information.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_v20_dd_systems_systemid_stats_get(system_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.rest_v20_dd_systems_systemid_stats_get_with_http_info(system_id, **kwargs)  # noqa: E501
        else:
            (data) = self.rest_v20_dd_systems_systemid_stats_get_with_http_info(system_id, **kwargs)  # noqa: E501
            return data

    def rest_v20_dd_systems_systemid_stats_get_with_http_info(self, system_id, **kwargs):  # noqa: E501
        """Get stats information.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_v20_dd_systems_systemid_stats_get_with_http_info(system_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method rest_v20_dd_systems_systemid_stats_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('system_id' not in params or
            ...
            raise ValueError("Missing the required parameter `system_id` when calling `rest_v20_dd_systems_systemid_stats_get`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_dd_auth_token' in params and
                                                       len(params['x_dd_auth_token']) < 1):
            raise ValueError("Invalid value for parameter `x_dd_auth_token` when calling `rest_v20_dd_systems_systemid_stats_get`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('exclude_fields' in params and not re.search(r'^([^,]+,*)+$', params['exclude_fields'])):  # noqa: E501
            raise ValueError("Invalid value for parameter `exclude_fields` when calling `rest_v20_dd_systems_systemid_stats_get`, must conform to the pattern `/^([^,]+,*)+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('include_fields' in params and not re.search(r'^([^,]+,*)+$', params['include_fields'])):  # noqa: E501
            raise ValueError("Invalid value for parameter `include_fields` when calling `rest_v20_dd_systems_systemid_stats_get`, must conform to the pattern `/^([^,]+,*)+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/rest/v2.0/dd-systems/{SYSTEM-ID}/stats', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
